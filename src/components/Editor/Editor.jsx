...
const Editor = ({ socketRef, setLiveCode, id, onCodeChange, editorRef }) => {
  ...
  const submit = async (e) => {
    const response = await fetch(process.env.REACT_APP_RAPID_URL, {
      method: "POST",
      headers: {
  ...
  return (
    <>
      <div class="flex h-10 mb-4 rounded bg-gray-50 dark:bg-gray-800">
